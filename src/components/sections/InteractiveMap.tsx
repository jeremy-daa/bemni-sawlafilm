...
// Ethiopia Bounding Box (Approximate for projection)
...
export default function InteractiveMap() {
  ...
  return (
    <section className="bg-ink py-[clamp(56px,8vw,100px)] border-t border-white/[0.06] overflow-hidden relative">
      ...
      <div className="max-w-[1240px] mx-auto px-[clamp(20px,4vw,48px)] relative z-10 grid md:grid-cols-3 gap-12 items-center">
        {/* Text Side */}
        ...
        <div className="md:col-span-2 relative h-[500px] md:h-[600px] bg-white/[0.02] rounded-[4px] border border-white/10 p-8 flex items-center justify-center order-1 md:order-2 reveal reveal-delay-200">
          {/* Abstract Map Shape (SVG from Public) */}
          <div className="relative w-full h-full max-w-xl aspect-[4/3] flex items-center justify-center">
                    ...
                    <AnimatePresence>
                      {activeLocation === loc.id && (
                        <motion.div
                          ...
                          className="absolute bottom-full left-1/2 -translate-x-1/2 mb-4 w-[280px] bg-ink/95 backdrop-blur-md border border-white/10 p-5 rounded-[4px] shadow-2xl z-30"
                        >
