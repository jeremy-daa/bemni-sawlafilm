...
export default function FilmingPermitsPage() {
  ...
  const imageRecord = records.find(item => item.slug === 'whatsapp-image-2026-05-18-at-16-40-59-4' || item.labelName === 'whatsapp-image-2026-05-18-at-16-40-59-4') || records[0];
