...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen">
        ...
        {backgroundRecord ? (
          <div className="absolute inset-0 z-0">
            <PremiumImage
              ...
              altText={
                backgroundRecord.seoDescription || backgroundRecord.altText
              }
        ...
        <div className="relative z-10 max-w-[1240px] mx-auto px-[clamp(20px,4vw,48px)]">
          ...
          <div className="max-w-[720px]">
            ...
            >
              Ethiopia-based.
              <br />
              <em className="text-gold not-italic italic">Field-tested.</em>
              <br />
              Producer-first.
            </h1>
            <p className="text-[14px] font-light text-white/55 leading-[1.8] mb-4">
              Sawla Films is an Ethiopia-based film fixer and production support
              company. We help international documentary, broadcast, factual,
              commercial, and independent production teams plan and execute
              shoots in Ethiopia with proper permits, practical logistics,
              respectful access, and calm on-ground coordination.
            </p>
            <p className="text-[14px] font-light text-white/40 leading-[1.8] mb-7 italic">
              We are not the production company. We are the operation that makes
              your production possible on the ground.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
            <div>
              ...
              <div className="space-y-4 text-[14px] font-light text-steel leading-[1.8]">
                <p>
                  Sawla Films grew out of Sawla Tours, a specialist Ethiopia
                  expedition and cultural travel company with deep field
                  relationships, logistics infrastructure, and regional
                  knowledge built over more than a decade of operating across
                  the country.
                </p>
                <p>
                  The film fixer operation was developed specifically to serve
                  international production teams who needed the same expedition
                  and access expertise — but applied to the requirements of
                  professional camera crews, broadcast deadlines, permit
                  compliance, equipment logistics, and shoot-day coordination.
                </p>
                <p>
                  Our team combines production experience with Ethiopia field
                  expertise: people who understand both what a producer needs on
                  a deadline and what it takes to move responsibly through
                  complex environments, sensitive communities, remote terrain,
                  and culturally significant locations.
                </p>
                <p>
                  We are based in Addis Ababa and operate across all twelve
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {REGIONS.map((region) => (
                  <div
                    key={region}
                    className="flex gap-2.5 items-center bg-warm border border-black/[0.07] rounded-[3px] px-4 py-2.5"
                  >
                    <span
                      className="w-1.5 h-1.5 rounded-full bg-ember flex-shrink-0"
                      aria-hidden="true"
                    />
                    <span className="text-[12px] font-light text-steel">
                      {region}
                    </span>
                  </div>
                ))}
              </div>
              <p className="mt-3 text-[11px] font-light text-silver/70 italic">
                All access-sensitive and security-sensitive regions are planned
                subject to current permissions, security conditions, and local
                authority guidance at the time of the shoot.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-[1240px] mx-auto px-[clamp(20px,4vw,48px)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {VALUES.map((v) => (
              <div
                key={v.title}
                className="bg-white/[0.04] border border-white/[0.07] rounded-[3px] p-6"
              >
                <h3 className="text-[13px] font-medium text-white mb-3 flex items-center gap-2.5">
                  <span
                    className="w-[3px] h-4 bg-ember rounded-[1px] flex-shrink-0"
                    aria-hidden="true"
                  />
                  {v.title}
                </h3>
                <p className="text-[13px] font-light text-white/50 leading-[1.75]">
                  {v.body}
                </p>
              </div>
            ))}
      ...
      {(() => {
        const img1 = records.find(
          (r) => r.slug === "whatsapp-image-2026-05-18-at-16-40-52-1",
        );
        const img2 = records.find(
          (r) => r.slug === "whatsapp-image-2026-05-18-at-16-40-52-2",
        );
        const img3 = records.find(
          (r) => r.slug === "whatsapp-image-2026-05-18-at-16-40-52-3",
        );
            ...
            <div className="max-w-[1240px] mx-auto px-[clamp(20px,4vw,48px)]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                {[img1, img2, img3].map((img) => (
                  <div
                    key={img.slug}
                    className="relative aspect-[4/3] rounded-[4px] overflow-hidden shadow-xl border border-white/[0.05]"
                  >
                    <PremiumImage
                      assets={img.assets}
        ...
        <div className="max-w-[1240px] mx-auto px-[clamp(20px,4vw,48px)]">
          <div className="max-w-[720px]">
            ...
            <p className="text-[14px] font-light text-steel leading-[1.8] mb-4">
              Sawla Tours is the parent operation from which Sawla Films
              developed. It is an Ethiopia-based specialist travel and
              expedition company that has operated across the country for over a
              decade.
            </p>
            <p className="text-[14px] font-light text-steel leading-[1.8] mb-5">
              Sawla Tours provides the infrastructure that makes certain Sawla
              Films services possible: field vehicles, experienced drivers,
              accommodation connections, expedition logistics, remote-area
              access relationships, guides, and the practical field knowledge
              that comes from years of operating in challenging environments.
              Many of the relationships that open doors for film productions
              were built through Sawla Tours long before those productions
              arrived.
            </p>
            <a
              href={SITE.sisterSite}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-[12px] font-medium text-teal-mid tracking-[0.05em] border-b border-teal-mid/30 pb-0.5 hover:border-teal-mid transition-colors"
            >
              Visit Sawla Tours →
            </a>
          </div>
        ...
        <div className="relative z-10 max-w-[1240px] mx-auto px-[clamp(20px,4vw,48px)]">
          <div className="max-w-[540px]">
            <h2 className="font-serif font-light text-white text-display-md italic leading-[1.2] mb-4">
              Work with us on your Ethiopia production
            </h2>
            <p className="text-[14px] font-light text-white/50 leading-[1.8] mb-7">
              Share your project type, dates, locations, crew size, and any
              access or complexity considerations. We will respond with
              practical next steps for permits, logistics, access, and on-ground
              support.
            </p>
